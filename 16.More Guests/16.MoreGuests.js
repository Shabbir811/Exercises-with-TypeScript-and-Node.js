...
let guest_list = ["shoaib", "junaid", "saad"];
//store a message to a variable
let message = ("I'm inviting you to my dinner event tonight.  ");
...
let new_guest = "rehaan";
//remove 1 guest name and add new one
guest_list.splice(guest_list.indexOf(ex_guest), 1, new_guest);
